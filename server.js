...
mongodb.initDb((err) => {
    if(err) {
        ...
        // app.listen(port, () => {console.log(`Databace: ON Node: RUNNING Port: ${port}`)});
        // if you are wondering what I did here, start the code and see the your inner nerd smile ;)
        app.listen(port, () => {
            console.log(`Databace: \x1b[32mCONNECTED\x1b[0m - Node: \x1b[32mRUNNING\x1b[0m - Listening: \x1b[32mPort:${port}\x1b[0m`);
